  ...
  return (
    <div>
      ...
      <Container className="collections my-5 mx-auto">
        ...
        >
          <Bounce>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ex nostrum qui libero natus, inventore corporis.
          </Bounce>
        </p>
        <Row className="mx-0">
      ...
      <Container>
        <Bounce bottom cascade>
          ...
          <p style={{ maxWidth: "650px" }} className="text-center mx-auto mt-3">
            {" "}
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nisi ipsam, dolore laudantium accusamus.
          </p>
        </Bounce>
        {!products.length ? (
